...
if (browser) {
    ...
    navigator.serviceWorker
        ...
        .then((registration) => {
            getToken(messaging, {
                vapidKey:
                    'BOFg_GZXkheciuX6MqSjd2vEoUG72BiYOpbP6z8J5kEwZoE7uu0DNGiHYII8HBjfYNM5NpJOQSGMS7Bzr8CQOk8',
    ...
    onMessage(messaging, (msg) => {
        ...
        if (msg.notification && document.visibilityState === 'hidden') {
            new Notification(msg.notification.title || 'DDR Queue', {
